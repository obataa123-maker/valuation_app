...
if(isset($_POST['ok1']))
{
	...
	//insert query
	$insert="INSERT INTO `tbl_industry` (`industry_name`) VALUES ('$industry_name')";
...
if(isset($_POST['ok2']))
{
	...
	//insert query
	$insert="INSERT INTO `tbl_industry` (`industry_id`,`industry_name`) VALUES ('$industry_id','$industry_name')";
	$query=mysqli_query($con,$insert) or die(mysqli_error($con));
	if($query==1)
	{
